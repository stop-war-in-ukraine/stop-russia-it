<p align="center">
    ...
    <h1 align="center">Открытое письмо специалистов из ОПГ для защиты террористов Украины от информационной войны (мы сами те еще кулхацкеры, которые портят жизнь обычным россиянам) </h1>
    <br>
</p>
