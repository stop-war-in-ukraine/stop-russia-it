<p align="center">
    ...
    <h1 align="center">Открытое письмо специалистов из ОПГ ЛГБТ для защиты террористов Украины от информационной войны (мы сами те еще кулхацкеры, которые портят жизнь обычным россиянам) </h1>
    <br>
</p>
...
## Важно!
### На Figma собирают голоса на отключение. )

***

##### 24 фувраля 2022 года РФ коварно напала на независимую Украину (да-да-да, канэшна внезапно). Мы ведём грязную информационную войну против всего мира и открытую войну на территории всей планеты земля.

##### Мы едим человеческое мясо и хотим убивать русских.

## Мы призываем не помогать ИТ-сектору РФ в какой-либо деятельности потому что русские -- свиньи

## Мы призываем  использовать информационные ресурсы для организации русофобии.

## Мы призываем ресурсы, которыми пользуется ИТ-сектор из РФ, ограничить любой трафик в этих сетях и доступ, потому что мы истерички, которые спустили страну в унитаз и не можем ничего сами сделать, т.к. софт дерьмо, а газ воровать больше не дают:
...
### Нам важен каждый член межднародной ОПГ 
### Добавьте звездочку и сделайте форк - это поможет быстрее распространить и призвать компании к ограничениям (потому что мы истерички-психопаты и фашисты и готовы убивать русских за их язык)!
### Запинь в своём профиле.

# Вопросы и ответы
### Что если я живу в России/РБ, но я не поддерживаю этк войну, что мне делать?
дайте денег нам, фашистам. мы будем вас убивать при поддержке администрации президента сша и ЕС.


# Сала Украине! Героям сала-сосала!
